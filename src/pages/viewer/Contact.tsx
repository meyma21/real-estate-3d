    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="pt-16">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-8">Contactez-nous</h1>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contact Information */}
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-semibold text-slate-800 mb-4">Nos coordonnées</h2>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Phone className="text-teal-600 mt-1" size={20} />
                    <div>
                      <p className="text-slate-800 font-medium">Téléphone</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">contact@projet-immobilier.fr</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-slate-800 font-medium">Adresse</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-slate-800 font-medium">Horaires d'ouverture</p>
                      <p className="text-slate-600">Lundi - Vendredi: 9h00 - 18h00</p>
                      <p className="text-slate-600">Samedi: 10h00 - 16h00</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-semibold text-slate-800 mb-4">Suivez-nous</h2>
            ...
            {/* Contact Form */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">Envoyez-nous un message</h2>
